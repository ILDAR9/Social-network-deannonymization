...
OUT_FOLDER_NAME = 'out'
PLOT_TITLE = 'Network reconcilation (VK, Instagram)'
FLG_SAVE_IMG = True
MAX_X = 200
MAX_Y = 25000
...
def plot_data():
    pref_gm1 = 'gm1_'
    pref_gm2 = 'gm2_'
    d = {pref_gm1 + 'label': 'ExpandWhenStuck',
         pref_gm1 + 'color': 'red',
         pref_gm1 + 'marker': 'o',
         pref_gm2 + 'label': 'ExpandWhenStuck with fname',
         pref_gm2 + 'color': 'blue',
         pref_gm2 + 'marker': 'x',
    ...
    def plot_of():
        ...
        for prefix in (pref_gm1, pref_gm2):
            ...
            pl.scatter(*zip(*read_data(data_file)), marker=d[prefix + 'marker'], label=d[prefix + 'label'],
